...
class MinesGame:
    ...
    def get_multiplier_for_opened_cells(self, opened_safe_cells):
        multipliers = {
            2: [1.08, 1.17, 1.29, 1.41, 1.56, 1.74, 1.94, 2.18, 2.48, 2.83, 3.26, 3.81, 4.5, 5.4, 6.6, 8.25, 10.61, 14.14, 19.8, 29.25, 39.75, 55.75, 133.5],
            3: [1.13, 1.29, 1.48, 1.71, 2.0, 2.35, 2.79, 3.35, 4.07, 6.26, 7.02, 8.87, 11.35, 14.70, 25.30, 36.70, 49.80, 79.10, 99.80, 137.50, 195.00, 415.00],
